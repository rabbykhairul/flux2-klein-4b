...
declare -A MODELS=(
    ["diffusion_models/flux-2-klein-4b.safetensors"]="Comfy-Org/flux2-klein|split_files/diffusion_models/flux-2-klein-4b.safetensors|diffusion_models|FLUX.2 klein 4B (distilled)"
    ["clip/qwen_3_4b_fp4_flux2.safetensors"]="Comfy-Org/flux2-klein|split_files/text_encoders/qwen_3_4b_fp4_flux2.safetensors|clip|Qwen3-4B text encoder (fp4)"
    ["vae/flux2-vae.safetensors"]="Comfy-Org/flux2-klein|split_files/vae/flux2-vae.safetensors|vae|FLUX.2 VAE"
)
